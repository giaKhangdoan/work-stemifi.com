...
function ServiceCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="mb-2 font-sans text-2xl font-medium tracking-tight text-foreground md:text-3xl">{service.title}</h3>
      <p className="max-w-sm font-sans text-sm leading-relaxed tracking-tight text-foreground/80 md:text-base">{service.description}</p>
    </div>
  )
}
