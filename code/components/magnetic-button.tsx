...
export function MagneticButton({
  ...
  const variants = {
    ...
    secondary:
      "bg-foreground/20 text-black hover:bg-foreground/30 backdrop-blur-xl border border-foreground/20 hover:border-foreground/30 font-medium",
    ghost: "bg-transparent text-white hover:bg-foreground/5 backdrop-blur-sm",
  }
